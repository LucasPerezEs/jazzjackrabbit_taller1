...
#include <memory>
#include "../../../client_src/setupscreen/GameList.h"
...
QT_MOC_LITERAL(1, 9, 16), // "refreshRequested"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "GameList\0refreshRequested\0"
};
...
void GameList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameList::refreshRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameList::refreshRequested()
{
